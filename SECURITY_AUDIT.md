...
4. Подтверждено, что заблокированные пользователи уже отсекаются:
   - при обычном логине;
   - при Telegram-логине;
...
2. Нужны транзакции/locks для балансов и выводов.
   Сейчас JSON-state сохраняется целиком, поэтому при параллельных оплатах или выводах возможна гонка.
