...
- [x] Автоматическое зеркало заказов в `orders`, если таблица создана.
- [x] Автоматическое зеркало депозитов в `wallet_deposits`, если таблица создана.
- [x] Автоматическое зеркало выводов в `wallet_withdrawals`, если таблица создана.
- [x] Автоматическое зеркало ledger в `ledger_entries`, если таблица создана.
- [x] Автоматическое зеркало NOWPayments IPN в `payment_ipn_events`, если таблица создана.
- [x] IP/user-agent сохраняются для новых пользовательских сессий.
...
- [ ] Переключить чтение заказов с JSON-state на таблицу `orders`.
- [ ] Переключить чтение выводов с JSON-state на таблицу `wallet_withdrawals`.
- [ ] Переключить чтение пополнений с JSON-state на таблицу `wallet_deposits`.
